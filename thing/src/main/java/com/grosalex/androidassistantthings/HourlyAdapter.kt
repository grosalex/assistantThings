...
class HourlyAdapter(private val mContext: Context, private val datas: ArrayList<HourlyWeather>) : RecyclerView.Adapter<HourlyAdapter.ViewHolder>() {
    ...
    class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        init {
            hoursTextView = v.findViewById<TextView>(R.id.hours)
            weatherTextView = v.findViewById<TextView>(R.id.hourly_weather)
            temperatureTextView = v.findViewById<TextView>(R.id.hourly_temperature)
            icon = v.findViewById<ImageView>(R.id.hourly_icon)
        }
    }
